...
pacman -Syuu
pacman -S --noconfirm xorg xfce4 xfce4-goodies lightdm lightdm-gtk-greeter pavucontrol fish doas terminator git firefox alsa-utils pulseaudio lib32-libpulse lib32-alsa-plugins
